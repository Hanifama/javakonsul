...
const WhyChooseUs: React.FC = () => {
  ...
  return (
    <section id="why-choose-us" ref={ref} className="container min-h-screen max-w-screen-xl mx-auto px-16 py-16">
      <div className="grid md:grid-cols-2 grid-cols-1 gap-8 items-center">
        ...
        >
          <div className="absolute -bottom-4 -left-4 md:-bottom-8 md:-left-8 w-full h-full bg-blue-100 rounded-lg shadow-lg z-0"></div>
        ...
        >
          <h2 className="text-lg font-bold text-blue-800 leading-tight">Kenapa Memilih Kami?</h2>
          <p className="text-4xl text-gray-700 mt-4 font-medium">
          ...
          <div className="mt-6 space-y-6">
            {[{
              ...
              >
                ...
                >
                  <CheckCircle className="text-blue-800 w-12 h-12" />
                </motion.div>
